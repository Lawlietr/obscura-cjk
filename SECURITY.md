...
**Security** tab and click [**Report a vulnerability**](https://github.com/Lawlietr/obscura-cjk/security/advisories/new)
to open a private advisory.

If you cannot use GitHub advisories, open a private conversation with the
repository owner (@Lawlietr) with "security" in the subject line.
